...
1. **Run automated checks** — Run the project's test suite, type checker, linter, and any verification steps listed in the plan. Report results.

2. **Walk me through manual checks** — For each deliverable, tell me exactly what to test and what to expect. Wait for my confirmation (pass/fail) on each one.
